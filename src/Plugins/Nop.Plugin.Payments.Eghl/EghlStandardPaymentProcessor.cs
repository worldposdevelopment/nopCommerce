...
using Nop.Plugin.Payments.Eghl;
using Nop.Plugin.Payments.Eghl.Services;
...
namespace Nop.Plugin.Payment.Eghl
{
    /// <summary>
    /// Eghl payment processor
    /// </summary>
    public class EghlPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields
        ...
        private readonly EghlHttpClient _EghlHttpClient;
        private readonly EghlPaymentSettings _EghlPaymentSettings;

        #endregion

        #region Ctor

        public EghlPaymentProcessor(CurrencySettings currencySettings,
            ...
            EghlHttpClient EghlHttpClient,
            EghlPaymentSettings EghlPaymentSettings)
        {
            ...
            _EghlHttpClient = EghlHttpClient;
            _EghlPaymentSettings = EghlPaymentSettings;
        }
        ...
        {
            response = WebUtility.UrlDecode(_EghlHttpClient.GetPdtDetailsAsync(tx).Result);
        ...
        {
            var response = WebUtility.UrlDecode(_EghlHttpClient.VerifyIpnAsync(formString).Result);
        ...
        private IDictionary<string, string> CreateQueryParameters(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                ["business"] = _EghlPaymentSettings.BusinessEmail,
                ...
                ["bn"] = EghlHelper.NopCommercePartnerCode,
                ...
                ["return"] = $"{storeLocation}Plugins/PaymentEghl/PDTHandler",
                ["notify_url"] = $"{storeLocation}Plugins/PaymentEghl/IPNHandler",
                ["cancel_return"] = $"{storeLocation}Plugins/PaymentEghl/CancelOrder",
        ...
        private void AddItemsParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, EghlHelper.OrderTotalSentToPayPal, roundedCartTotal);
        }
        ...
        private void AddOrderTotalParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            //save order total that actually sent to PayPal (used for PDT order total validation)
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, EghlHelper.OrderTotalSentToPayPal, roundedOrderTotal);
        }
        ...
        public decimal GetAdditionalHandlingFee(IList<ShoppingCartItem> cart)
        {
            return _paymentService.CalculateAdditionalFee(cart,
                _EghlPaymentSettings.AdditionalFee, _EghlPaymentSettings.AdditionalFeePercentage);
        }
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentEghl/Configure";
        }
        ...
        {
            //settings
            _settingService.SaveSetting(new EghlPaymentSettings
            {
                UseSandbox = true
            });
            ...
            {
                ["Plugins.Payments.Eghl.Fields.AdditionalFee"] = "Additional fee",
                ["Plugins.Payments.Eghl.Fields.AdditionalFee.Hint"] = "Enter additional fee to charge your customers.",
                ["Plugins.Payments.Eghl.Fields.AdditionalFeePercentage"] = "Additional fee. Use percentage",
                ["Plugins.Payments.Eghl.Fields.AdditionalFeePercentage.Hint"] = "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.",
                ["Plugins.Payments.Eghl.Fields.BusinessEmail"] = "Business Email",
                ["Plugins.Payments.Eghl.Fields.BusinessEmail.Hint"] = "Specify your PayPal business email.",
                ["Plugins.Payments.Eghl.Fields.PassProductNamesAndTotals"] = "Pass product names and order totals to PayPal",
                ["Plugins.Payments.Eghl.Fields.PassProductNamesAndTotals.Hint"] = "Check if product names and order totals should be passed to PayPal.",
                ["Plugins.Payments.Eghl.Fields.PDTToken"] = "PDT Identity Token",
                ["Plugins.Payments.Eghl.Fields.PDTToken.Hint"] = "Specify PDT identity token",
                ["Plugins.Payments.Eghl.Fields.RedirectionTip"] = "You will be redirected to PayPal site to complete the order.",
                ["Plugins.Payments.Eghl.Fields.UseSandbox"] = "Use Sandbox",
                ["Plugins.Payments.Eghl.Fields.UseSandbox.Hint"] = "Check to enable Sandbox (testing environment).",
                ["Plugins.Payments.Eghl.Instructions"] = @"
                    <p>
                ...
                ["Plugins.Payments.Eghl.PaymentMethodDescription"] = "You will be redirected to PayPal site to complete the payment",
                ["Plugins.Payments.Eghl.RoundingWarning"] = "It looks like you have \"ShoppingCartSettings.RoundPricesDuringCalculation\" setting disabled. Keep in mind that this can lead to a discrepancy of the order total amount, as PayPal only rounds to two decimals.",
        ...
        {
            //settings
            _settingService.DeleteSetting<EghlPaymentSettings>();

            //locales
            _localizationService.DeletePluginLocaleResources("Plugins.Payments.Eghl");
        ...
        /// </summary>
        public string PaymentMethodDescription => _localizationService.GetResource("Plugins.Payments.Eghl.PaymentMethodDescription");
