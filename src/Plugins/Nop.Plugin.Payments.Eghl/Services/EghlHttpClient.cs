...
namespace Nop.Plugin.Payments.Eghl.Services
{
    /// <summary>
    /// Represents the HTTP client to request PayPal services
    /// </summary>
    public partial class EghlHttpClient
    {
        #region Fields

        private readonly HttpClient _httpClient;
        private readonly EghlPaymentSettings _payPalStandardPaymentSettings;

        #endregion

        #region Ctor

        public EghlHttpClient(HttpClient client,
            EghlPaymentSettings payPalStandardPaymentSettings)
        {
            //configure client
