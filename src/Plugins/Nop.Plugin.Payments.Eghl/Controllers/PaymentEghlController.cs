...
using Nop.Plugin.Payment.Eghl;
using Nop.Plugin.Payments.Eghl.Models;
...
namespace Nop.Plugin.Payments.Eghl.Controllers
{
    [AutoValidateAntiforgeryToken]
    public class PaymentEghlController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentEghlController(IGenericAttributeService genericAttributeService,
        ...
        public IActionResult Configure()
        {
            ...
            var payPalStandardPaymentSettings = _settingService.LoadSetting<EghlPaymentSettings>(storeScope);
            ...
            if (storeScope <= 0)
                return View("~/Plugins/Payments.Eghl/Views/Configure.cshtml", model);
        ...
        public IActionResult RoundingWarning(bool passProductNamesAndTotals)
        {
            ...
            if (passProductNamesAndTotals && !_shoppingCartSettings.RoundPricesDuringCalculation)
                return Json(new { Result = _localizationService.GetResource("Plugins.Payments.Eghl.RoundingWarning") });
        ...
        public IActionResult PDTHandler()
        {
            ...
            if (!(_paymentPluginManager.LoadPluginBySystemName("Payments.Eghl") is EghlPaymentProcessor processor) || !_paymentPluginManager.IsPluginActive(processor))
            ...
            if (processor.GetPdtDetails(tx, out var values, out var response))
            {
                ...
                var newPaymentStatus = EghlHelper.GetPaymentStatus(paymentStatus, string.Empty);
        ...
        public IActionResult IPNHandler()
        {
            ...
            var newPaymentStatus = EghlHelper.GetPaymentStatus(paymentStatus, pendingReason);
            sb.AppendLine("New payment status: " + newPaymentStatus);
